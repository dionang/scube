...
<body class="theme-red">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="javascript:void(0);" class="navbar-toggle collapsed"
					...
					class="bars"></a> <a class="navbar-brand" href="index.html">ADMINB2B</a>
			</div>
	...
	<section>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="user-info">
				<div class="image">
					<img src="/assets/images/user.png" width="48" height="48"
						alt="User" />
				</div>
				<div class="info-container">
					<div class="name" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false">ADMIN</div>
					<div class="email">admin@b2bsales.com</div>
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="/dashboardpage"> <i
							class="material-icons">home</i> <span>Dashboard</span>
					</a></li>


					<li><a href="/addcompanypage; javascript:void(0);"
						class="menu-toggle"> <i class="material-icons">work</i> <span>Company</span>
					</a>
						<ul class="ml-menu">
							<li><a href="javascript:void(0);" class="menu-toggle"> <span>Cards</span>
							</a>
							</li>
							<li><a href="javascript:void(0);" class="menu-toggle"> <span>Product</span>
							</a>
								<ul class="ml-menu">
									<li><a href="pages/widgets/infobox/infobox-1.html">View
											Product</a></li>
									<li><a href="pages/widgets/infobox/infobox-2.html">Add
											Product</a></li>
									<li><a href="pages/widgets/infobox/infobox-3.html">Edit
											Product</a></li>
								</ul></li>
						</ul></li>

					<li><a href="/addproductpage; javascript:void(0);"
						class="menu-toggle"> <i class="material-icons">shopping_cart</i>
							<span>Product</span>
					</a></li>
					<li><a href="/salesmanpage; javascript:void(0);"
						class="menu-toggle"> <i class="material-icons">people</i> <span>Salesman</span>
					</a></li>
					<li><a href="/salespage;javascript:void(0);"
						class="menu-toggle"> <i class="material-icons">show_chart</i>
							<span>Sales</span>
					</a></li>
					<li><a href="/gautam/try" 
						class="menu-toggle"> <i class="material-icons">show_chart</i>
							<span>try</span>
					</a></li><li>
					<a href="/lan/pro" 
