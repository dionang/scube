		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="javascript:void(0);" class="navbar-toggle collapsed"
					...
					class="bars"></a> <a class="navbar-brand" href="index.html">SALESMAN
					B2B</a>
			</div>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="user-info">
				...
				<div class="info-container">
					<div class="name" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false">SALESMAN</div>
					<div class="email">salesman@b2bsales.com</div>
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="/salesmanDashboard"> <i
							class="material-icons">home</i> <span>Dashboard</span>
					</a></li>

					<li><a href="/addsalespage;javascript:void(0);"
						class="menu-toggle"> <i class="material-icons">show_chart</i>
							<span>Sales</span>
					</a></li>

					<li><a href="/crudpage;javascript:void(0);"
						class="menu-toggle"> <i class="material-icons">local_drink</i>
							<span>Cup</span>
					</a></li>
